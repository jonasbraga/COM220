...
class LimitePrincipal():
  def __init__(self, root, controle):
    ...
    self.estudanteMenu.add_command(label="Inserir", command=self.controle.insereEstudantes)
    self.estudanteMenu.add_command(label="Mostrar", command=self.controle.mostraEstudantes)
    ...
    self.discipMenu.add_command(label="Mostrar", command=self.controle.mostraDisciplinas)
    ...
    self.turmaMenu.add_command(label="Inserir", command=self.controle.insereTurmas)
    self.turmaMenu.add_command(label="Mostrar", command=self.controle.mostraTurmas)
...
class ControlePrincipal():       
  def __init__(self):
    ...
    self.root.title("Gerenciamento de universidade")
